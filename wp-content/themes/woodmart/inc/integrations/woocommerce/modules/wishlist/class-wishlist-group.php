...
class Wishlists_Group extends Singleton {
	...
	public function wishlist_create_group_popup() {
		...
		<div class="mfp-with-anim wd-popup wd-close-btn-inset wd-popup-wishlist">
			...
			<a href="#" data-group-id="save" class="btn btn-color-primary btn-full-width wd-wishlist-save-btn" data-added-text="<?php esc_html_e( 'Thêm yêu thích', 'woodmart' ); ?>" data-create-text="<?php esc_html_e( 'Tạo yêu thích', 'woodmart' ); ?>" data-move-text="<?php esc_html_e( 'Move to wishlist', 'woodmart' ); ?>">
