	...
	<div class="wrapp-category">
		...
		<div class="hover-mask">
			...
			<?php if ( ! $args['hide_product_count'] ) : ?>
				<div class="more-products"><a href="<?php echo esc_url( get_term_link( $args['category']->slug, 'product_cat' ) ); ?>"><?php echo sprintf( _n( '%s sản phẩm', '%s sản phẩm', $args['category']->count, 'woodmart' ), $args['category']->count ); ?></a></div>
			<?php endif; ?>
